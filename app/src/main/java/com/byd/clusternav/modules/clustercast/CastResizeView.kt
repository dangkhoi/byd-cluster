...
class CastResizeView(
    ...
    private fun toClusterX(vx: Float): Int = (vx * scaleX()).toInt().coerceIn(0, clusterWidth)
    ...
    private fun applyDrag(dx: Float, dy: Float) {
        ...
        when (dragTarget) {
            ...
            DragTarget.CENTER -> {
                ...
                val nl = (dragStartRect.left + dx).coerceIn(0f, width - w)
        ...
        rectLeft = rectLeft.coerceIn(0, clusterWidth)
        rectTop = rectTop.coerceIn(0, clusterHeight)
        rectRight = rectRight.coerceIn(0, clusterWidth)
    ...
    fun setBounds(l: Int, t: Int, r: Int, b: Int) {
        rectLeft = l; rectTop = t; rectRight = r; rectBottom = b; invalidate()
    }
}
