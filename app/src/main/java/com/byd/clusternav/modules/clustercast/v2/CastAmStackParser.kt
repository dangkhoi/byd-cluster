...
internal sealed interface CastDumpParse<out T> {
...
internal data class CastAmStackRecord(val stackId: Int, val displayId: Int)

internal data class CastAmTaskRecord(
    val stackId: Int,
    val displayId: Int,
    val taskId: Int,
...
internal class CastAmStackSnapshot(
...
internal object CastAmStackParser {
