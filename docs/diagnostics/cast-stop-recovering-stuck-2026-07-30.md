...
nay). Người báo: KhoiPD — cast VietMap lên cụm OK, bấm nút nổi để trả về màn chính không có tác dụng, hiện
...
4. Thêm test hồi quy dựng từ đúng dump này (`CastAdbGatewayTest` hoặc tương đương) khoá lại: dòng "brought
   ...
   `UnknownEffect`.
5. Riêng biệt: KhoiPD có yêu cầu UX — bong bóng bớt hiệu ứng mờ-tự-động (fade), luôn giữ độ rõ đủ để không
